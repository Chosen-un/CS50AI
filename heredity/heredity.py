    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            for parent in [mother, father]:
                ...
                if parent_genes == 0:
                    prob_from_parents[parent] = PROBS["mutation"]
                elif parent_genes == 1:
                    prob_from_parents[parent] = 0.5
                else: 
                    prob_from_parents[parent] = 1 - PROBS["mutation"]

            p_mother = prob_from_parents[mother]
            p_father = prob_from_parents[father]
